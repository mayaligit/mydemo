...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882">
  <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
    ...
    <Created>2018-01-02T08:02:31Z</Created>
    <LastSaved>2018-01-03T04:28:13Z</LastSaved>
  </DocumentProperties>
  ...
  <Worksheet ss:Name="Sheet1">
    <Table ss:ExpandedColumnCount="7" ss:ExpandedRowCount="${attendanceList?size + 6}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="14.25">
      <Column ss:Index="1" ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="108"/>
      <Column ss:Index="2" ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="123" ss:Span="1"/>
      <Column ss:Index="4" ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="143.25"/>
      <Column ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="227.25"/>
      <Column ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="129.75"/>
      <Column ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="226.5"/>
      <Row>
        <Cell ss:StyleID="s50">
        ...
        <Cell ss:StyleID="s50">
          <Data ss:Type="String">所属考勤组</Data>
        </Cell>
        <Cell ss:StyleID="s50">
          <Data ss:Type="String">上班打卡时间</Data>
        </Cell>
        <Cell ss:StyleID="s50">
          <Data ss:Type="String">上班打卡地址</Data>
        </Cell>
        <Cell ss:StyleID="s50">
          <Data ss:Type="String">下班打卡时间</Data>
        </Cell>
        <Cell ss:StyleID="s50">
          <Data ss:Type="String">下班打卡地址</Data>
        </Cell>
      </Row>
    <#list attendanceList as attendance>
        <Row>
            <Cell>
                <Data ss:Type="String">${attendance.attendanceUser}</Data>
            </Cell>
            <Cell>
                <Data ss:Type="String">${attendance.telephone}</Data>
            </Cell>
            <Cell>
                <Data ss:Type="String"><#if attendance.attendanceGroup ??>${attendance.attendanceGroup}</#if></Data>
            </Cell>
            <Cell>
                <Data ss:Type="String"><#if attendance.startTime ??>${attendance.startTime?string('yyyy年MM月dd日 HH:mm:ss')}</#if></Data>
            </Cell>
            <Cell>
                <Data ss:Type="String"><#if attendance.startLocation ??>${attendance.startLocation}</#if></Data>
            </Cell>
            <Cell>
                <Data ss:Type="String"><#if attendance.endTime ??>${attendance.endTime?string('yyyy年MM月dd日 HH:mm:ss')}</#if></Data>
            </Cell>
            <Cell>
                <Data ss:Type="String"><#if attendance.endLocation ??>${attendance.endLocation}</#if></Data>
            </Cell>
        </Row>
    </#list>
    </Table>
    <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
      ...
      <Panes>
        <Pane>
          ...
          <RangeSelection>R3C3</RangeSelection>
        </Pane>
      </Panes>
